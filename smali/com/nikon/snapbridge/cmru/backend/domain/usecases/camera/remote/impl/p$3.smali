.class final synthetic Lcom/nikon/snapbridge/cmru/backend/domain/usecases/camera/remote/impl/p$3;
.super Ljava/lang/Object;


# annotations
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/nikon/snapbridge/cmru/backend/domain/usecases/camera/remote/impl/p;
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/nikon/snapbridge/cmru/backend/domain/usecases/camera/remote/impl/p$3;->b:[I

    const/4 v0, 0x1

    :try_start_0
    sget-object v1, Lcom/nikon/snapbridge/cmru/backend/domain/usecases/camera/remote/impl/p$3;->b:[I
    ...
    :try_start_1
    sget-object v2, Lcom/nikon/snapbridge/cmru/backend/domain/usecases/camera/remote/impl/p$3;->b:[I

    sget-object v3, Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraMovieWhiteBalance;->DIRECT_SUNLIGHT:Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraMovieWhiteBalance;
    ...
    :try_start_2
    sget-object v3, Lcom/nikon/snapbridge/cmru/backend/domain/usecases/camera/remote/impl/p$3;->b:[I

    sget-object v4, Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraMovieWhiteBalance;->FLUORESCENT:Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraMovieWhiteBalance;
    ...
    :try_start_3
    sget-object v4, Lcom/nikon/snapbridge/cmru/backend/domain/usecases/camera/remote/impl/p$3;->b:[I
    ...
    :try_start_4
    sget-object v5, Lcom/nikon/snapbridge/cmru/backend/domain/usecases/camera/remote/impl/p$3;->b:[I

    sget-object v6, Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraMovieWhiteBalance;->CLOUDY:Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraMovieWhiteBalance;
    ...
    :try_start_5
    sget-object v6, Lcom/nikon/snapbridge/cmru/backend/domain/usecases/camera/remote/impl/p$3;->b:[I

    sget-object v7, Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraMovieWhiteBalance;->SHADE:Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraMovieWhiteBalance;
    ...
    :try_start_6
    sget-object v7, Lcom/nikon/snapbridge/cmru/backend/domain/usecases/camera/remote/impl/p$3;->b:[I

    sget-object v8, Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraMovieWhiteBalance;->SAME_STILL_IMAGE:Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraMovieWhiteBalance;
    ...
    :try_start_7
    sget-object v8, Lcom/nikon/snapbridge/cmru/backend/domain/usecases/camera/remote/impl/p$3;->b:[I

    sget-object v9, Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraMovieWhiteBalance;->UNKNOWN:Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraMovieWhiteBalance;
    ...
    sput-object v8, Lcom/nikon/snapbridge/cmru/backend/domain/usecases/camera/remote/impl/p$3;->a:[I

    :try_start_8
    sget-object v8, Lcom/nikon/snapbridge/cmru/backend/domain/usecases/camera/remote/impl/p$3;->a:[I
    ...
    :catch_8
    :try_start_9
    sget-object v0, Lcom/nikon/snapbridge/cmru/backend/domain/usecases/camera/remote/impl/p$3;->a:[I

    sget-object v8, Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraWhiteBalance;->DIRECT_SUNLIGHT:Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraWhiteBalance;

    invoke-virtual {v8}, Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraWhiteBalance;->ordinal()I
    ...
    invoke-virtual {v1}, Lcom/nikon/snapbridge/cmru/backend/data/entities/camera/CameraWhiteBalance;->ordinal()I
