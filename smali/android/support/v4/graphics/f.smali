...
.method public final a(Landroid/content/Context;Landroid/support/v4/content/a/c$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    iget-object p2, p2, Landroid/support/v4/content/a/c$b;->a:[Landroid/support/v4/content/a/c$c;
    ...
    iget-object v3, v0, Landroid/support/v4/content/a/c$c;->a:Ljava/lang/String;

    iget v4, v0, Landroid/support/v4/content/a/c$c;->e:I

    iget v5, v0, Landroid/support/v4/content/a/c$c;->b:I

    iget-boolean v6, v0, Landroid/support/v4/content/a/c$c;->c:Z

    iget-object v0, v0, Landroid/support/v4/content/a/c$c;->d:Ljava/lang/String;
...
.method public final a(Landroid/content/Context;[Landroid/support/v4/b/d$b;I)Landroid/graphics/Typeface;
    .locals 11
    ...
    invoke-virtual {p0, p2, p3}, Landroid/support/v4/graphics/f;->a([Landroid/support/v4/b/d$b;I)Landroid/support/v4/b/d$b;
    ...
    :try_start_0
    iget-object p3, p2, Landroid/support/v4/b/d$b;->a:Landroid/net/Uri;
    ...
    :cond_6
    invoke-static {p1, p2}, Landroid/support/v4/b/d;->a(Landroid/content/Context;[Landroid/support/v4/b/d$b;)Ljava/util/Map;
    ...
    iget-object v4, v3, Landroid/support/v4/b/d$b;->a:Landroid/net/Uri;
    ...
    iget v5, v3, Landroid/support/v4/b/d$b;->b:I

    iget v6, v3, Landroid/support/v4/b/d$b;->c:I

    iget-boolean v7, v3, Landroid/support/v4/b/d$b;->d:Z
