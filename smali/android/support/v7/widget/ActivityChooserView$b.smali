...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p1, p1, Landroid/support/v7/widget/ActivityChooserView$a;->a:Landroid/support/v7/widget/c;

    invoke-virtual {p1}, Landroid/support/v7/widget/c;->b()Landroid/content/pm/ResolveInfo;
...
.method public final onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iget-object p2, p1, Landroid/support/v7/widget/c;->b:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    invoke-virtual {p1}, Landroid/support/v7/widget/c;->c()V

    iget-object p4, p1, Landroid/support/v7/widget/c;->c:Ljava/util/List;

    invoke-interface {p4, p3}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object p3

    check-cast p3, Landroid/support/v7/widget/c$a;
    ...
    check-cast p4, Landroid/support/v7/widget/c$a;

    if-eqz p4, :cond_0

    iget p4, p4, Landroid/support/v7/widget/c$a;->b:F

    iget p5, p3, Landroid/support/v7/widget/c$a;->b:F
    ...
    iget-object v0, p3, Landroid/support/v7/widget/c$a;->a:Landroid/content/pm/ResolveInfo;

    iget-object v0, v0, Landroid/content/pm/ResolveInfo;->activityInfo:Landroid/content/pm/ActivityInfo;

    iget-object v0, v0, Landroid/content/pm/ActivityInfo;->packageName:Ljava/lang/String;

    iget-object p3, p3, Landroid/support/v7/widget/c$a;->a:Landroid/content/pm/ResolveInfo;
    ...
    new-instance p3, Landroid/support/v7/widget/c$c;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v0

    invoke-direct {p3, p5, v0, v1, p4}, Landroid/support/v7/widget/c$c;-><init>(Landroid/content/ComponentName;JF)V

    invoke-virtual {p1, p3}, Landroid/support/v7/widget/c;->a(Landroid/support/v7/widget/c$c;)Z
