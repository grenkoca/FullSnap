...
.field private l:Landroid/support/v4/d/m;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/d/m<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Landroid/support/v7/widget/k;->d:[I
    ...
    sput-object v2, Landroid/support/v7/widget/k;->e:[I
    ...
    sput-object v2, Landroid/support/v7/widget/k;->f:[I
...
.method private static declared-synchronized a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-static {p0, p1}, Landroid/support/v7/widget/k$c;->a(ILandroid/graphics/PorterDuff$Mode;)I
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/k$c;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v2, p0, v1}, Landroid/support/v7/widget/k$c;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
...
.method private a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    invoke-static {p4}, Landroid/support/v4/graphics/drawable/a;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p3, v0, v1}, Landroid/support/v7/widget/k;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, p3}, Landroid/support/v7/widget/az;->a(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/az;->c(Landroid/content/Context;I)I
...
.method private declared-synchronized a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, p2, p3, v1}, Landroid/support/v4/d/f;->a(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    iget-object p1, v0, Landroid/support/v4/d/f;->c:[J

    iget v2, v0, Landroid/support/v4/d/f;->e:I

    invoke-static {p1, v2, p2, p3}, Landroid/support/v4/d/c;->a([JIJ)I

    move-result p1

    if-ltz p1, :cond_2

    iget-object p2, v0, Landroid/support/v4/d/f;->d:[Ljava/lang/Object;

    aget-object p2, p2, p1

    sget-object p3, Landroid/support/v4/d/f;->a:Ljava/lang/Object;
    ...
    iput-boolean p1, v0, Landroid/support/v4/d/f;->b:Z
    :try_end_2
...
.method public static declared-synchronized a()Landroid/support/v7/widget/k;
    ...
    invoke-direct {v1, v2, v3}, Landroid/support/v7/widget/k;->a(Ljava/lang/String;Landroid/support/v7/widget/k$d;)V
...
.method static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bb;[I)V
    ...
    :goto_1
    iget-boolean v2, p1, Landroid/support/v7/widget/bb;->c:Z
    ...
    invoke-static {p2, p1}, Landroid/support/v7/widget/k;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method private a(Ljava/lang/String;Landroid/support/v7/widget/k$d;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/k;->k:Landroid/support/v4/d/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/k;->k:Landroid/support/v4/d/a;
...
.method static a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    :cond_5
    invoke-static {p0, v2}, Landroid/support/v7/widget/az;->a(Landroid/content/Context;I)I
...
.method private c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/k;->l:Landroid/support/v4/d/m;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v7/widget/k;->l:Landroid/support/v4/d/m;

    invoke-virtual {v0, p2, v1}, Landroid/support/v4/d/m;->a(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/k;->k:Landroid/support/v4/d/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/k;->l:Landroid/support/v4/d/m;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/k;->l:Landroid/support/v4/d/m;

    invoke-virtual {v7, p2, v2}, Landroid/support/v4/d/m;->c(ILjava/lang/Object;)V

    iget-object v7, p0, Landroid/support/v7/widget/k;->k:Landroid/support/v4/d/a;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/k;->l:Landroid/support/v4/d/m;

    const-string v0, "appcompat_skip_skip"

    invoke-virtual {p1, p2, v0}, Landroid/support/v4/d/m;->c(ILjava/lang/Object;)V
...
.method private static d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v3}, Landroid/support/v7/widget/az;->c(Landroid/content/Context;I)I

    move-result p0

    sget-object v3, Landroid/support/v7/widget/az;->a:[I
    ...
    sget-object p0, Landroid/support/v7/widget/az;->d:[I
    ...
    sget-object p0, Landroid/support/v7/widget/az;->b:[I
    ...
    sget-object p0, Landroid/support/v7/widget/az;->h:[I
...
.method final declared-synchronized a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    iput-boolean v1, p0, Landroid/support/v7/widget/k;->o:Z
    ...
    invoke-virtual {p0, p1, v7}, Landroid/support/v7/widget/k;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, v1}, Landroid/support/v7/widget/k;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method final declared-synchronized a(Landroid/content/Context;Landroid/support/v7/widget/bi;I)Landroid/graphics/drawable/Drawable;
    .locals 1

    monitor-enter p0

    :try_start_0
    invoke-direct {p0, p1, p3}, Landroid/support/v7/widget/k;->c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final declared-synchronized a(Landroid/content/Context;)V
    ...
    check-cast p1, Landroid/support/v4/d/f;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Landroid/support/v4/d/f;->c()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method final declared-synchronized b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, Landroid/support/v7/widget/az;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v6, Landroid/support/v7/widget/az;->a:[I
    ...
    sget-object v2, Landroid/support/v7/widget/az;->e:[I
    ...
    sget-object v2, Landroid/support/v7/widget/az;->h:[I
    ...
    invoke-static {p1, v3}, Landroid/support/v7/widget/az;->c(Landroid/content/Context;I)I
    ...
    :goto_3
    invoke-static {p1, v0}, Landroid/support/v7/widget/k;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/k;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_8
    sget-object v0, Landroid/support/v7/widget/k;->e:[I

    invoke-static {v0, p2}, Landroid/support/v7/widget/k;->a([II)Z
    ...
    :cond_9
    sget-object v0, Landroid/support/v7/widget/k;->h:[I
    ...
    :cond_a
    sget-object v0, Landroid/support/v7/widget/k;->i:[I
    ...
    iget-object v2, p0, Landroid/support/v7/widget/k;->j:Ljava/util/WeakHashMap;

    invoke-virtual {v2, p1, v0}, Ljava/util/WeakHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_f
    invoke-virtual {v0, p2, v1}, Landroid/support/v4/d/m;->c(ILjava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
