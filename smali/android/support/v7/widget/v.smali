...
.method protected final drawableStateChanged()V
    ...
    iget-object v1, v0, Landroid/support/v7/widget/w;->c:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, v0, Landroid/support/v7/widget/w;->b:Landroid/widget/SeekBar;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/w;->b:Landroid/widget/SeekBar;
...
.method public final jumpDrawablesToCurrentState()V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/w;->c:Landroid/graphics/drawable/Drawable;
...
.method protected final declared-synchronized onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v0, Landroid/support/v7/widget/w;->b:Landroid/widget/SeekBar;
    ...
    iget-object v3, v0, Landroid/support/v7/widget/w;->c:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v3}, Landroid/graphics/drawable/Drawable;->getIntrinsicWidth()I

    move-result v3

    iget-object v4, v0, Landroid/support/v7/widget/w;->c:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, v0, Landroid/support/v7/widget/w;->b:Landroid/widget/SeekBar;
    ...
    iget-object v4, v0, Landroid/support/v7/widget/w;->b:Landroid/widget/SeekBar;
    ...
    iget-object v5, v0, Landroid/support/v7/widget/w;->b:Landroid/widget/SeekBar;
    ...
    iget-object v5, v0, Landroid/support/v7/widget/w;->c:Landroid/graphics/drawable/Drawable;
