.class final Landroid/support/v7/widget/ae$4;
...
# direct methods
.method constructor <init>(Landroid/support/v7/widget/ae;Landroid/support/v7/widget/RecyclerView$v;Landroid/view/ViewPropertyAnimator;Landroid/view/View;)V
    .locals 0
...
.method public final onAnimationEnd(Landroid/animation/Animator;)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/ae$4;->b:Landroid/view/ViewPropertyAnimator;

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Landroid/view/ViewPropertyAnimator;->setListener(Landroid/animation/Animator$AnimatorListener;)Landroid/view/ViewPropertyAnimator;

    iget-object p1, p0, Landroid/support/v7/widget/ae$4;->c:Landroid/view/View;

    const/high16 v0, 0x3f800000    # 1.0f

    invoke-virtual {p1, v0}, Landroid/view/View;->setAlpha(F)V

    iget-object p1, p0, Landroid/support/v7/widget/ae$4;->d:Landroid/support/v7/widget/ae;

    iget-object v0, p0, Landroid/support/v7/widget/ae$4;->a:Landroid/support/v7/widget/RecyclerView$v;

    invoke-virtual {p1, v0}, Landroid/support/v7/widget/ax;->e(Landroid/support/v7/widget/RecyclerView$v;)V

    iget-object p1, p0, Landroid/support/v7/widget/ae$4;->d:Landroid/support/v7/widget/ae;

    iget-object p1, p1, Landroid/support/v7/widget/ae;->f:Ljava/util/ArrayList;
