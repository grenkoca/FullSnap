...
.method public final run()V
    ...
    iget-object v0, v0, Landroid/support/v7/app/AppCompatDelegateImpl;->k:Landroid/widget/PopupWindow;

    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImpl$6;->a:Landroid/support/v7/app/AppCompatDelegateImpl;

    iget-object v1, v1, Landroid/support/v7/app/AppCompatDelegateImpl;->j:Landroid/support/v7/widget/ActionBarContextView;
    ...
    iget-object v2, v2, Landroid/support/v7/app/AppCompatDelegateImpl;->j:Landroid/support/v7/widget/ActionBarContextView;

    invoke-static {v2}, Landroid/support/v4/view/o;->j(Landroid/view/View;)Landroid/support/v4/view/r;

    move-result-object v2

    invoke-virtual {v2, v1}, Landroid/support/v4/view/r;->a(F)Landroid/support/v4/view/r;

    move-result-object v1

    iput-object v1, v0, Landroid/support/v7/app/AppCompatDelegateImpl;->m:Landroid/support/v4/view/r;

    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImpl$6;->a:Landroid/support/v7/app/AppCompatDelegateImpl;

    iget-object v0, v0, Landroid/support/v7/app/AppCompatDelegateImpl;->m:Landroid/support/v4/view/r;
