...
.method constructor <init>(Landroid/support/c/a/i$g;)V
    ...
    iput-object p1, p0, Landroid/support/c/a/i;->e:Landroid/graphics/PorterDuffColorFilter;
...
.method private b(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v5, v3, Landroid/support/c/a/i;->b:Landroid/support/c/a/i$g;

    iget-object v6, v5, Landroid/support/c/a/i$g;->b:Landroid/support/c/a/i$f;

    new-instance v7, Ljava/util/ArrayDeque;

    invoke-direct {v7}, Ljava/util/ArrayDeque;-><init>()V

    iget-object v8, v6, Landroid/support/c/a/i$f;->c:Landroid/support/c/a/i$c;
    ...
    check-cast v15, Landroid/support/c/a/i$c;
    ...
    new-instance v8, Landroid/support/c/a/i$b;

    invoke-direct {v8}, Landroid/support/c/a/i$b;-><init>()V

    sget-object v11, Landroid/support/c/a/a;->c:[I

    invoke-static {v0, v4, v2, v11}, Landroid/support/v4/content/a/g;->a(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v11

    invoke-virtual {v8, v11, v1, v4}, Landroid/support/c/a/i$b;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;)V

    invoke-virtual {v11}, Landroid/content/res/TypedArray;->recycle()V

    iget-object v11, v15, Landroid/support/c/a/i$c;->b:Ljava/util/ArrayList;

    invoke-virtual {v11, v8}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v8}, Landroid/support/c/a/i$b;->getPathName()Ljava/lang/String;

    move-result-object v11

    if-eqz v11, :cond_1

    iget-object v11, v6, Landroid/support/c/a/i$f;->k:Landroid/support/v4/d/a;

    invoke-virtual {v8}, Landroid/support/c/a/i$b;->getPathName()Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v11, v12, v8}, Landroid/support/v4/d/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_1
    iget v11, v5, Landroid/support/c/a/i$g;->a:I

    iget v8, v8, Landroid/support/c/a/i$b;->o:I

    or-int/2addr v8, v11

    iput v8, v5, Landroid/support/c/a/i$g;->a:I
    ...
    invoke-static {v1, v12}, Landroid/support/v4/content/a/g;->a(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z

    move-result v12

    if-eqz v12, :cond_3

    sget-object v12, Landroid/support/c/a/a;->d:[I

    invoke-static {v0, v4, v2, v12}, Landroid/support/v4/content/a/g;->a(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v12

    invoke-virtual {v8, v12}, Landroid/support/c/a/i$a;->a(Landroid/content/res/TypedArray;)V

    invoke-virtual {v12}, Landroid/content/res/TypedArray;->recycle()V

    :cond_3
    iget-object v12, v15, Landroid/support/c/a/i$c;->b:Ljava/util/ArrayList;
    ...
    iget-object v12, v6, Landroid/support/c/a/i$f;->k:Landroid/support/v4/d/a;

    invoke-virtual {v8}, Landroid/support/c/a/i$a;->getPathName()Ljava/lang/String;

    move-result-object v13

    invoke-virtual {v12, v13, v8}, Landroid/support/v4/d/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_4
    iget v12, v5, Landroid/support/c/a/i$g;->a:I
    ...
    sget-object v12, Landroid/support/c/a/a;->b:[I
    ...
    iput-object v13, v8, Landroid/support/c/a/i$c;->l:[I

    const-string v13, "rotation"

    const/4 v14, 0x5

    iget v10, v8, Landroid/support/c/a/i$c;->c:F

    invoke-static {v12, v1, v13, v14, v10}, Landroid/support/v4/content/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v10

    iput v10, v8, Landroid/support/c/a/i$c;->c:F

    iget v10, v8, Landroid/support/c/a/i$c;->d:F
    ...
    iget v10, v8, Landroid/support/c/a/i$c;->e:F
    ...
    iget v14, v8, Landroid/support/c/a/i$c;->f:F

    const/4 v13, 0x3

    invoke-static {v12, v1, v10, v13, v14}, Landroid/support/v4/content/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    iget v14, v8, Landroid/support/c/a/i$c;->g:F
    ...
    iget v14, v8, Landroid/support/c/a/i$c;->h:F
    ...
    iget v14, v8, Landroid/support/c/a/i$c;->i:F
    ...
    iget-object v10, v15, Landroid/support/c/a/i$c;->b:Ljava/util/ArrayList;
    ...
    iget-object v10, v6, Landroid/support/c/a/i$f;->k:Landroid/support/v4/d/a;

    invoke-virtual {v8}, Landroid/support/c/a/i$c;->getGroupName()Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v10, v12, v8}, Landroid/support/v4/d/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_7
    iget v10, v5, Landroid/support/c/a/i$g;->a:I
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v9, p0, Landroid/support/c/a/i;->k:Landroid/graphics/Rect;
    ...
    iget-object v6, p0, Landroid/support/c/a/i;->b:Landroid/support/c/a/i$g;

    iget-object v7, v6, Landroid/support/c/a/i$g;->f:Landroid/graphics/Bitmap;
    ...
    iput-object v7, v6, Landroid/support/c/a/i$g;->f:Landroid/graphics/Bitmap;

    iput-boolean v5, v6, Landroid/support/c/a/i$g;->k:Z

    :cond_a
    iget-boolean v6, p0, Landroid/support/c/a/i;->d:Z

    if-nez v6, :cond_b

    iget-object v6, p0, Landroid/support/c/a/i;->b:Landroid/support/c/a/i$g;

    invoke-virtual {v6, v1, v3}, Landroid/support/c/a/i$g;->a(II)V
    ...
    iget-boolean v7, v6, Landroid/support/c/a/i$g;->k:Z

    if-nez v7, :cond_c

    iget-object v7, v6, Landroid/support/c/a/i$g;->g:Landroid/content/res/ColorStateList;

    iget-object v8, v6, Landroid/support/c/a/i$g;->c:Landroid/content/res/ColorStateList;

    if-ne v7, v8, :cond_c

    iget-object v7, v6, Landroid/support/c/a/i$g;->h:Landroid/graphics/PorterDuff$Mode;

    iget-object v8, v6, Landroid/support/c/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;

    if-ne v7, v8, :cond_c

    iget-boolean v7, v6, Landroid/support/c/a/i$g;->j:Z

    iget-boolean v8, v6, Landroid/support/c/a/i$g;->e:Z

    if-ne v7, v8, :cond_c

    iget v7, v6, Landroid/support/c/a/i$g;->i:I

    iget-object v6, v6, Landroid/support/c/a/i$g;->b:Landroid/support/c/a/i$f;

    invoke-virtual {v6}, Landroid/support/c/a/i$f;->getRootAlpha()I
    ...
    iget-object v3, v1, Landroid/support/c/a/i$g;->c:Landroid/content/res/ColorStateList;

    iput-object v3, v1, Landroid/support/c/a/i$g;->g:Landroid/content/res/ColorStateList;

    iget-object v3, v1, Landroid/support/c/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;

    iput-object v3, v1, Landroid/support/c/a/i$g;->h:Landroid/graphics/PorterDuff$Mode;

    iget-object v3, v1, Landroid/support/c/a/i$g;->b:Landroid/support/c/a/i$f;

    invoke-virtual {v3}, Landroid/support/c/a/i$f;->getRootAlpha()I

    move-result v3

    iput v3, v1, Landroid/support/c/a/i$g;->i:I

    iget-boolean v3, v1, Landroid/support/c/a/i$g;->e:Z

    iput-boolean v3, v1, Landroid/support/c/a/i$g;->j:Z

    iput-boolean v2, v1, Landroid/support/c/a/i$g;->k:Z
    ...
    iget-object v6, v1, Landroid/support/c/a/i$g;->b:Landroid/support/c/a/i$f;
    ...
    :cond_f
    iget-object v2, v1, Landroid/support/c/a/i$g;->l:Landroid/graphics/Paint;
    ...
    iput-object v2, v1, Landroid/support/c/a/i$g;->l:Landroid/graphics/Paint;
    ...
    iget-object v5, v1, Landroid/support/c/a/i$g;->b:Landroid/support/c/a/i$f;

    invoke-virtual {v5}, Landroid/support/c/a/i$f;->getRootAlpha()I
    ...
    iget-object v0, v1, Landroid/support/c/a/i$g;->l:Landroid/graphics/Paint;

    :goto_5
    iget-object v1, v1, Landroid/support/c/a/i$g;->f:Landroid/graphics/Bitmap;
...
.method public final inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-static {v1, p2, v4, v5, v6}, Landroid/support/v4/content/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    :goto_0
    iput-object v5, v2, Landroid/support/c/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v5, v2, Landroid/support/c/a/i$g;->c:Landroid/content/res/ColorStateList;

    :cond_4
    const-string v5, "autoMirrored"

    iget-boolean v8, v2, Landroid/support/c/a/i$g;->e:Z
    ...
    :goto_1
    iput-boolean v8, v2, Landroid/support/c/a/i$g;->e:Z

    const-string v2, "viewportWidth"

    const/4 v5, 0x7

    iget v6, v3, Landroid/support/c/a/i$f;->f:F

    invoke-static {v1, p2, v2, v5, v6}, Landroid/support/v4/content/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v2

    iput v2, v3, Landroid/support/c/a/i$f;->f:F

    const-string v2, "viewportHeight"

    const/16 v5, 0x8

    iget v6, v3, Landroid/support/c/a/i$f;->g:F

    invoke-static {v1, p2, v2, v5, v6}, Landroid/support/v4/content/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v2

    iput v2, v3, Landroid/support/c/a/i$f;->g:F

    iget v2, v3, Landroid/support/c/a/i$f;->f:F
    ...
    iget v2, v3, Landroid/support/c/a/i$f;->g:F

    cmpg-float v2, v2, v5

    if-lez v2, :cond_9

    iget v2, v3, Landroid/support/c/a/i$f;->d:F

    invoke-virtual {v1, v7, v2}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, v3, Landroid/support/c/a/i$f;->d:F

    const/4 v2, 0x2

    iget v6, v3, Landroid/support/c/a/i$f;->e:F

    invoke-virtual {v1, v2, v6}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, v3, Landroid/support/c/a/i$f;->e:F
    ...
    iget v2, v3, Landroid/support/c/a/i$f;->e:F
    ...
    invoke-virtual {v3}, Landroid/support/c/a/i$f;->getAlpha()F
    ...
    invoke-virtual {v3, v2}, Landroid/support/c/a/i$f;->setAlpha(F)V
    ...
    iput-object v2, v3, Landroid/support/c/a/i$f;->i:Ljava/lang/String;

    iget-object v5, v3, Landroid/support/c/a/i$f;->k:Landroid/support/v4/d/a;

    invoke-virtual {v5, v2, v3}, Landroid/support/v4/d/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-boolean v4, v0, Landroid/support/c/a/i$g;->k:Z
    ...
    iget-object p1, v0, Landroid/support/c/a/i$g;->c:Landroid/content/res/ColorStateList;

    iget-object p2, v0, Landroid/support/c/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-direct {p0, p1, p2}, Landroid/support/c/a/i;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method protected final onStateChange([I)Z
    ...
    invoke-direct {p0, v0, v2}, Landroid/support/c/a/i;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    :cond_1
    invoke-virtual {v1}, Landroid/support/c/a/i$g;->a()Z
    ...
    iget-object v2, v2, Landroid/support/c/a/i$f;->c:Landroid/support/c/a/i$c;

    invoke-virtual {v2, p1}, Landroid/support/c/a/i$c;->a([I)Z
